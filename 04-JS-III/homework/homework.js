...
function devolverUltimoElemento(array) {
  ...
  // Tu código:
  //para tomar el largo de un array usamos .lenght
  //los array empiezan en pocision "cero"
...
function agregarItemAlFinalDelArray(array, elemento) {
  ...
  // y devuelve el array
  // Tu código:
   // ---- pushh agrega un elemento al final del array --!!
  array.push(elemento);
  return array;
...
function dePalabrasAFrase(palabras) {
  ...
  // Tu código:
  //-----> usamos el metodo de array join() si no le pongo nada en el parentesis pega las palabras
...
function cuentoElementos(arreglo){
  ...
  //Escribe tu código aquí
  //--> se puede hacer con filtro
  // var mayora18=arreglo.filter(element >=18);
  //var total = mayora18.length;
  //return total;
  var win = [];
